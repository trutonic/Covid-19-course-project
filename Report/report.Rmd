...
author: "Ian Whaling, 914014658, Samuel Becerra Martinez, Esmeralda Buenrostro, Ryan Truong 916857334, Team ID: 9"
date: "March 3rd, 2021"
output:
  html_document:
    df_print: paged
...
The spread of COVID-19 had detrimental effects on economic activities following the worldwide lockdowns. Our primary interest was whether there were differences among countries' ability to recover from the initial economic impacts of COVID-19 due to overall wealth and proportion of the population with COVID-19 infections.

# Introduction

COVID-19 came to shock the world socially, politically, and economically. Many governments made the decision to lockdown their countries in response to COVID-19 as a way to limit the spread of the virus. This came with direct costs to economic activities as many businesses were forced to halt their operations or adapt to regulations in order to keep productivity afloat. In this paper, we measure the impact of COVID-19 on the economy by examining the effects of COVID-related cases on nominal GDP change. We use GDP as a measurement of the economy as it tracks income and spending in the economy, and it can be compared with other countries and across time. We also note the various lockdown announcements in March of 2020 to carefully observe the changes in GDP around that time. 
 
Our primary interest is whether there are differences across countries’ ability to recover from the initial economic impacts of COVID-19 due to the factors: proportion of the population with COVID-19 infections and relative wealth of a nation. The incentive behind this question was the lockdown and the closure of many businesses worldwide as a preventative measure to limit the spread of the virus. According to Maliszewska, Mattoo, van der Mensbrugghe (2020), the preventative actions for COVID-19 have had an immediate and significant impact on all economies. We questioned how the economy would respond in the months following the initial closure of many economic activities and whether factors like wealth and the number of positive COVID-19 results had an impact on these results. If certain countries seem to recuperate their GDP losses from the initial impacts of COVID-19 quicker than others, then the country’s overall wealth and proportion of the population with COVID-19 may have been factors.

These results may give us an indication of how economies are likely to respond to global pandemics such as COVID-19 in the future. If higher proportions of cases have larger negative impacts on the economy, then a country may consider placing even stricter restrictions on their country at the beginning of a pandemic to lessen the negative economic impacts. Similarly, if a country has a lower GDP relative to other countries, it may have difficulty recovering from the initial impacts of a pandemic which may lead to a collapse of their economy or require intervention from another country. 
...
The population that we are interested in is nations and their change in GDP. We will be attempting to model this population respective to their levels of proportion of people that are infected with COVID-19 and GDP per capita (as a measure of overall wealth).

To measure the differences across countries' abilities to recover from the initial impacts of COVID-19, we choose to split the data into fiscal quarters, which are quarter periods that align with a regular calendar year. We decided to use quarter 3 in 2020 or Q3 to measure the recovery from the initial impacts of COVID-19 mainly seen in Q2. To keep within this time frame, we summed all the COVID-19 cases within Q3, which spans from July 1, 2020 to September 30, 2020. The variables that we chose to include are “Change_3_months” which explains the percentage change in GDP for each country. We also included “increase_cat”, which groups the countries based on the proportion of their populations infected by COVID-19. “Gdp_cat” groups countries based on their relative wealth, measured by GDP per capita. 
...
Gross Domestic Product (GDP) by country: the latest data. (n.d.). Retrieved March 03, 2021, from https://www.theglobaleconomy.com/rankings/gdp_current_local_currency/
GDP per capita, current dollars - Country rankings. (n.d.). Retrieve March 03, 2021, from https://www.theglobaleconomy.com/rankings/GDP_per_capita_current_dollars/
