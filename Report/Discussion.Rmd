...
4. There were a few instances where the word ‘impact’ was used, mainly in the context of describing how Covid-19 had an ‘impact’ on economic activity due to the two variables. However, there should not be any causal statements made in the project. We can only conclude that there are associations because there may be other factors that can contribute to this economic activity.
